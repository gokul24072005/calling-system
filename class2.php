...
<head>
  ...
  <div class="text-center mb-4">
    <h2>💐 Join Our Online Saree Draping Class</h2>
    <p class="text-muted">Become confident in saree draping for any occasions</p>
  </div>
  ...
  <div class="row g-4">
    <div class="col-md-6">
      <div class="form-box">
        ...
        <ul>
          <li><strong>Course:</strong> Saree draping</li>
          <li><strong>Mode:</strong> Live + Demo videos</li>
        ...
        <ul>
          <li>Master bridal saree draping in various styles.</li>
          <li>Master party saree draping in various styles.</li>
          <li>Master traditional saree draping in various styles.</li>
        </ul>

        <h5 class="mt-4">💰 Fee</h5>
        <p><strong>Starts at ₹599</strong></p>
      </div>
    </div>
