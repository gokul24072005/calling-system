...
<head>
  ...
  <div class="text-center mb-4">
    <h2>🌿  Join Our Online Mehndi art workshop</h2>
    <p class="text-muted">Become confident in mehndi designs</p>
  </div>
  ...
  <div class="row g-4">
    <div class="col-md-6">
      <div class="form-box">
        ...
        <ul>
          <li><strong>Course:</strong>Mehndi art workshop</li>
          <li><strong>Mode:</strong> Live workshop</li>
        ...
        <ul>
          <li>Glitter or Colored Mehndi</li>
          <li>Indian mehndi</li>
          <li>Arabic mehndi</li>
          <li>Moroccan Mehndi</li>
        </ul>

        <h5 class="mt-4">💰 Fee</h5>
        <p><strong>Starts at ₹999</strong></p>
      </div>
    </div>
